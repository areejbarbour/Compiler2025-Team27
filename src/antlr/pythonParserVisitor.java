...
public interface pythonParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code argExprStmt}
	 * labeled alternative in {@link pythonParser#args}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArgExprStmt(pythonParser.ArgExprStmtContext ctx);
	/**
	 * Visit a parse tree produced by the {@code keywordArgStmt}
	 * labeled alternative in {@link pythonParser#args}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitKeywordArgStmt(pythonParser.KeywordArgStmtContext ctx);
	/**
	 * Visit a parse tree produced by {@link pythonParser#keywordArg}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
