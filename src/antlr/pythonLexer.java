// Generated from C:/Users/DELL/Documents/Compiler2025-Team27-main/src/antlr/pythonLexer.g4 by ANTLR 4.13.2
package antlr;
...
public class pythonLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"TRUE", "FALSE", "NONE", "CM", "LKB", "RKB", "LSB", "RSB", "LPAREN", 
			"RPAREN", "COL", "DOT", "AT", "ASSIGN", "PLUS", "MINUS", "IF", "FOR", 
			"WHILE", "DEF", "RETURN", "ELSE", "ELIF", "BREAK", "AND", "OR", "IS", 
			"NOT", "IN", "GT", "LT", "GE", "LE", "EQ", "NE", "FROM", "IMPORT", "ID", 
			"STRING", "ESC", "DOUBLE", "INT", "NUM", "EXP", "DIGIT", "NEWLINE", "SP", 
			"COMMENT"
		};
	}
